    ...
    public class ScrollBackGround : RC_RenderableBounded
    {
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            if (direction == 2) //Horizontal scroll
            {
                ...
                source1 = new Rectangle(CurrentX, sourceRectangle.Y, sourceRectangle.Width-(int)scrollH, sourceRectangle.Height);
                screen1 = new Rectangle(bounds.X + (int)(scrollH * ratio), bounds.Y, bounds.Width- (int)(scrollH * ratio), bounds.Height);
                
                source2 = new Rectangle(CurrentX + s, sourceRectangle.Y, (int)scrollH, sourceRectangle.Height );
        ...
        public void UpdateRectangle(int sourceX)
        {
            CurrentX = sourceX;
        }
