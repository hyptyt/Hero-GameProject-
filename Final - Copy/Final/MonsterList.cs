...
{
    class MonsterList: RC_Renderable
    {
        Monsters[] sprite;
        ...
        public MonsterList(int NumOfSprites)
        {
        ...
        private void initialise(int NumOfSprites)
        {
            ...
            sprite = new Monsters[numOfSprites];
...
/// <returns></returns>
        ...
        /// <returns></returns>
        public int addSprite(Monsters spriteZ)
        {
        ...
        /// <param name="spriteZ"></param>
        /// <returns></returns>
        public int addSpriteReuse(Monsters spriteZ)
        {
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public Monsters getSprite(int i)
        {
            return sprite[i];
        }
        ...
        /// <param name="i"></param>
        /// <param name="spriteZ"></param>
        public void setSprite(int i, Monsters spriteZ)
        {
            sprite[i] = spriteZ;
        ...
        /// Tick is used in Monsters to make a sprite visible after a certain time 
        /// </summary>
        public void Tick()
        {
            for (int i = 0; i < highUsed + 1; i++)
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public int collisionAA(Monsters s)
        {
        ...
        /// <returns></returns>
        public int collisionAA(Monsters s, int self)
        {
            if (s==null) return -1;
        ...
        /// the function has the formal parameters bool name(Monsters s)
        /// </summary>
        /// <param name="methodName"></param>
        /// <returns></returns>
        public bool RunTheMethod(Func<Monsters, bool> methodName)
        {
            bool retv = true;
            for (int i = 0; i < highUsed + 1; i++)
            {
