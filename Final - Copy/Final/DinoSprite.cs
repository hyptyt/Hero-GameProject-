...
{
    public class DinoSprite : Sprite3
    {
        int dirAnim;
        ...
        public DinoSprite(bool visible, Texture2D dino, float x, float y, int xsize, int ysize, int dirAnimInit) : base(visible, dino, x, y)
        {
            setXframes(24);
            setYframes(1);
        ...
        public void animationStart12(int dirAnimVal)
        {
            ...
            switch (dirAnim)
            {
                case 0:
                    ...
                    break;
                case 1:
                    setAnimationSequence(seqKick, firstFrameA[dirAnim], lastFrameA[dirAnim], ticksFrameA[dirAnim]);
                    break;
                case 2:
                    setAnimationSequence(seqRun, firstFrameA[dirAnim], lastFrameA[dirAnim], ticksFrameA[dirAnim]);
                    break;
                case 3:
